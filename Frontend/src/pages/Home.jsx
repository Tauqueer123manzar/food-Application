  ...
  return (
    <>
      <Container fluid style={{ maxWidth: "100vw", maxHeight: "100vh" }}>
        <Row>
          <Col xs={12} md={6} lg={5}>
            <h1 className='mt-3 p-4' style={{ fontWeight: "700", fontFamily: "initial", fontSize: "50px" }}>
              <Typewriter
            ...
            <Button className='btn btn-outline-warning' style={{fontWeight:"600",fontSize:"20px",height:"55px",width:"180px",marginLeft:"25px"}}>Explore Now</Button>
          </Col>
          <Col xs={12} md={5} lg={7}>
